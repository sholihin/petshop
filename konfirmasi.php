...
<button class="btn-warning" type="button" onclick="window.location.href='index.php?page=transfer&inv=<?php echo $row['id_invoice']; ?>&p=<?php echo $row['total_tagihan']; ?>'">Konfirmasi <i class="fa fa-arrow-circle-right"></i></button>.
<p></p>
</div>
</div>